...
print("\n\n\n\n Hello and welcome to the adventure hero! If this is your first time playing, you should type in 'how "
      "to 'play' so that you can learn to play the game. If you have played the game before, know the game's code, or "
...
if opt == 'start':
    ...
    print("\n\n\n\nHOW TO PLAY: \n\n MAIN CONTROLS: There are multiple things you can do in this game. To move around "
          ...
          "see what you are holding, input \"check items\" and to drop an item, input \"drop\". You can also look for "
          ...
          "you can choose to fight by typing \"yes\" or try to run by typing \"run\". To choose which enemy to attack, "
